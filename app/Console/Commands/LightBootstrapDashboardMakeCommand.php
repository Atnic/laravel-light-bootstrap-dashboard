...
namespace Atnic\LightBootstrapDashboard\Console\Commands;

use Illuminate\Console\Command;

class LightBootstrapDashboardMakeCommand extends Command
{
    /**
     ...
     * @var string
     */
    protected $signature = 'make:light-bootstrap-dashboard {--views : Only scaffold the views}';
     ...
     * @var string
     */
    protected $description = 'Scaffold basic make:auth with Ligt Bootstrap Dashboard Template';
    ...
    public function handle()
    {
        ...
        $this->info('Start Light Bootstrap Dashboard scaffolding');
        ...
        $this->info('Light Bootstrap Dashboard scaffolding generated successfully.');
    }
